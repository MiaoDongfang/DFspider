...
# My Library
from ..spiders import WebSpider
from ..instances import DownLoader, Parser, MysqlSaver
from ..models import Request
from ..util import db
from ..util.log import logger
from ..util.url_filter import get_url_filter
from ..util.config_util import CONFIG_URLPATTERN_FILES
from ..configs import configs
from ..util.date_format import date_format
from ..util.html_utils import filter_tags
from ..util.db import next_id
from ..errors import ParserError, DownloaderError, OverTimeError
from ..util.html_utils import fix_html, remove_blank
...
class CdgySpider(Parser):
    ...
    def parse_article(self, response, url_filter):
        ...
        html_content = remove_blank(html_content)
        # 针对文章开头含有./XXXX文件路径的html
